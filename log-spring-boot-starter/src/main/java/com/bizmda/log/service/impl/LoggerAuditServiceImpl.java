package com.bizmda.log.service.impl;

import com.bizmda.log.model.Audit;
import com.bizmda.log.service.IAuditService;
...
public class LoggerAuditServiceImpl implements IAuditService {
     ...
     * 例子：2020-02-04 09:13:34.650|user-center|com.bizmda.user.controller.SysUserController|saveOrUpdate|1|admin|webApp|新增用户:admin
     */
    @Override
